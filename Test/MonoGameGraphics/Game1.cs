...
namespace MonoGameGraphics
{
    public class Game1 : Game
    {
        ...
        private MeshTriangle3Collection tris = MeshParser.FromFile("C:\\Users\\harry\\Desktop\\Mathi\\NerdFramework\\Test\\luke.obj").polygons;
        ...
        protected override void LoadContent()
        {
            ...
            {
                using (FileStream fs = new FileStream("C:\\Users\\harry\\Desktop\\Mathi\\NerdFramework\\Test\\texture\\" + name, FileMode.Open))
                {
                    textures.Add(name, ConvertTexture(Texture2D.FromStream(_graphics.GraphicsDevice, fs)));
                }
            }

            renderer.AddMaterials(MaterialParser.FromFile("C:\\Users\\harry\\Desktop\\Mathi\\NerdFramework\\Test\\luke.mtl", textures));
